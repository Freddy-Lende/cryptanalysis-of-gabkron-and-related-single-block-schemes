...
with contextlib.redirect_stdout(io.StringIO()):  # mute stab_structure self-test
    from stab_structure import (GF, matmul, transpose, moore, kron, ident, inverse,
